package me.vexon.client.modules.vexonesp; // Vexon client

import me.vexon.client.client.VexonClient;
import me.vexon.client.events.event.GameRenderListener;
import me.vexon.client.events.event.TickListener;
import me.vexon.client.gui.settings.BooleanSetting;
...
import me.vexon.client.modules.client.Friends;
import me.vexon.client.modules.misc.AutoReconnect;
import me.vexon.client.utils.Character.RotateCharacter;
import me.vexon.client.utils.ChatUtils;
import me.vexon.client.utils.WebhookUtils;
...
import static me.vexon.client.client.VexonClient.eventManager;
...
public class SpawnerProtect extends Module implements TickListener, GameRenderListener {
    ...
    public void onEnable() {
        ...
        rotateChar = new RotateCharacter(VexonClient.mc);
    ...
    void checkPlayer() {
        ...
        Friends friends = VexonClient.moduleManager.getModule(Friends.class);
        AutoReconnect autoReconnect = VexonClient.moduleManager.getModule(AutoReconnect.class);
